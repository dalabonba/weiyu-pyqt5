...
//
//	// 設定輸出深度圖的資料夾路徑
//	std::string outputDirectory = "D://Users//user//Desktop//VTKcode//GAN//depth90//";
...
//		// 設定缺陷和對咬牙的路徑
//		std::string path1 = "D://Users//user//Desktop//VTKcode//GAN//training//" + folderName + "//"+outputtype+"//";
//		std::string path2 = "D://Users//user//Desktop//VTKcode//GAN//training//" + folderName + "//Up//";
//		// 迭代處理缺陷和對咬牙的文件
...
//
//							// 設置輸出深度圖的文件路徑
//							std::string outputFilePath = outputDirectory + folderName + "//"+ outputtype +"//" + fileName1.substr(0, fileName1.find(".")) + ".png";
//
