...
//
//	// 設定輸出深度圖的資料夾路徑
//	std::string outputDirectory = "D://Users//user//Desktop//weiyunxdelete//GANdata//trainingdepth//0817//";
//	std::string ouputdata = "Up";
//
//
...
//		// 設定缺陷和對咬牙的路徑
//		std::string path1 = "D://Users//user//Desktop//weiyunxdelete//GANdata//training//" + folderName + "//Prep//";
//		std::string path2 = "D://Users//user//Desktop//weiyunxdelete//GANdata//training//" + folderName + "//Up//";
//		// 迭代處理缺陷和對咬牙的文件
...
//							polyData1 = cleanFilter2->GetOutput();
//							double bounds1[6];
