...
class SingleDepthView(BaseView):  # 继承 BaseView
    def __init__(self, parent_layout):
        super().__init__(parent_layout)  # 调用 BaseView 的构造函数

    def create_depth_panel(self,parent_layout,current_panel):
        if current_panel:
        ...
        upper_button.clicked.connect(lambda: self.choose_file(self.upper_file))  # 使用 BaseView 的 choose_file
        ...
        lower_button.clicked.connect(lambda: self.choose_file(self.lower_file))  # 使用 BaseView 的 choose_file
